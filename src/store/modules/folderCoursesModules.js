// Dependencies ===============
const folderCoursesModules = {};

// State ======================

folderCoursesModules.state = {
	tableId: 'folderCoursesModulesTable',
	apiModule: 'courses',
	storeModule: 'courses',
	apiModuleTable: '',
	rows: [],
...
folderCoursesModules.mutations = {
	'ROWS'(state, rows) {
...
folderCoursesModules.actions = {
	setIdModules(idCourses, idModules) {
		return folderCoursesModules.state.apiModuleTable = 'courses/' + idCourses + '/modules/' + idModules + '/attachments';
	},
...
export default folderCoursesModules
