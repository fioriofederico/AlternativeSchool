        ...
        <b-col lg="12">
          ...
          <b-form-group>
            <b-form-file
                ...
                id="video"
                v-model="form.url"
                placeholder="Scegliere il File da Caricare o Trascinalo Qui..."
...
<script>
	...
	export default {
      ...
      createImage(item, file) {
        ...
        //TODO modifica dei vari nomi dei campi da image a file
        ...
        // Inizializza il loader
				...
				if(res.status == 200) {
					...
					this.$root.$emit('bv::refresh::table', 'folderCoursesModulesTable')
