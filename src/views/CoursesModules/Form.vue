	...
	<validation-observer ref="observer" v-slot="{ invalid }">
		<b-form @submit.stop.prevent="" autocomplete="off" class="vld-parent" ref="formContainer">
			...
			<b-row>
				<b-col lg="12">
					<label for="name">
						Nome del Modulo <small class="text-danger">*</small>
					</label>
      ...
      apiModuleTable: String,
        ...
        // Inizializza il loader
				...
				if(res.status == 200) {
					...
					this.$root.$emit('bv::refresh::table', 'coursesModulesTable')

				} else {
          this.$bvToast.toast(`L'operazione di creazione del modulo si è interrotta riprova tra qualche secondo`, {
